...
class RaptorGraphScalarDefinitionBuilder<Value : Any> internal constructor(
	...
	private var parseBoolean: (RaptorGraphArgumentParsingScope.(input: Boolean) -> Value)? = null
	private var parseFloat: (RaptorGraphArgumentParsingScope.(input: Double) -> Value)? = null
	private var parseObject: (RaptorGraphArgumentParsingScope.(input: Map<String, *>) -> Value)? = null
	private var parseInt: (RaptorGraphArgumentParsingScope.(input: Int) -> Value)? = null
	private var parseJson: (RaptorGraphArgumentParsingScope.(input: Any) -> Value)? = null
	private var parseString: (RaptorGraphArgumentParsingScope.(input: String) -> Value)? = null
	...
	@RaptorDsl
	fun parseBoolean(parse: RaptorGraphArgumentParsingScope.(input: Boolean) -> Value) {
	...
	@RaptorDsl
	fun parseFloat(parse: RaptorGraphArgumentParsingScope.(input: Double) -> Value) {
	...
	@RaptorDsl
	fun parseInt(parse: RaptorGraphArgumentParsingScope.(input: Int) -> Value) {
	...
	@RaptorDsl
	inline fun <reified JsonInput : Any> parseJson(noinline parse: RaptorGraphArgumentParsingScope.(input: JsonInput) -> Value) =
		parseJson(jsonInputClass = JsonInput::class, parse = parse)


	@RaptorDsl
	fun <JsonInput : Any> parseJson(jsonInputClass: KClass<out JsonInput>, parse: RaptorGraphArgumentParsingScope.(input: JsonInput) -> Value) {
		check(parseJson === null) { "Cannot define multiple JSON parsers." }

		this.jsonInputClass = jsonInputClass

		@Suppress("UNCHECKED_CAST")
		parseJson = parse as RaptorGraphArgumentParsingScope.(input: Any) -> Value
	}


	@RaptorDsl
	fun parseObject(parse: RaptorGraphArgumentParsingScope.(input: Map<String, *>) -> Value) {
	...
	@RaptorDsl
	fun parseString(parse: RaptorGraphArgumentParsingScope.(input: String) -> Value) {
