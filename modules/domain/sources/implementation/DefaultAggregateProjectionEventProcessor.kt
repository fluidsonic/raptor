...
// TODO Add lifecycle.
internal class DefaultAggregateProjectionEventProcessor(
	private val definitions: RaptorAggregateDefinitions,
	private val eventSource: RaptorEventSource,
) : RaptorAggregateProjectionEventSource {
	...
	private class Subscription<
		...
		fun handle(event: RaptorAggregateProjectionEvent<Id, Projection, Change>): Job? =
