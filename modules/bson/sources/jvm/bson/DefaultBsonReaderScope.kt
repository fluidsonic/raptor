...
internal class DefaultBsonReaderScope(
	...
	override fun timestamp(): Timestamp =
		Timestamp.of(millisecondsSince1970 = Milliseconds(underlyingReader.readDateTime()))
		...
		return when (type.classifier) {
			...
			HashSet::class, LinkedHashSet::class, MutableSet::class, Set::class ->
				...
				if (type.arguments.isNotEmpty())
					error("Cannot decode generic type '$type'.")
				...
				when (bsonType()) {
					BsonType.NULL -> when (type.isMarkedNullable) {
						...
						codecRegistry.decode(scope = this, valueClass = valueClass) as Value
					}
				}
			}
		}
